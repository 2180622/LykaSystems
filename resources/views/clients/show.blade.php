...
<div class="container mt-2">
    ...
    <a href="{{route('produtos.edit',$produto)}}" class="btn_list_opt btn_list_opt_edit" title="Editar"><i
            class="fas fa-pencil-alt mr-2"></i></a>

    <form method="POST" role="form" id="{{$produto->idProduto}}" action="{{route('produtos.destroy',$produto)}}"
        class="d-inline-block form_produto_id">
        @csrf
        @method('DELETE')
...
<div class="tab-pane fade" id="documentation" role="tabpanel" aria-labelledby="documentation-tab">
    ...
    <div class="row mt-2 pl-2 ">
        ...
        <div class="col mr-3">
            ...
            <div class="border rounded bg-light p-3">
                {{-- CC IDENTIFICAÇÃO --}}
                <div><span class="text-secondary">Número de identificação pessoal:</span> {{$client->num_docOficial}}
                </div>
                <br>
        ...
        <div class="col" style="min-width:250px">
            ...
            <div class="mt-4"><a href="{{route('produtos.create',$client)}}" class="top-button"><i
                        class="fas fa-plus mr-2"></i>Carregar Documentos</a></div>
