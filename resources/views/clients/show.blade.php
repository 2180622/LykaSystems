            ...
            <div class="row mt-4">
                ...
                <div class="col col-3 p-2 mr-3" style="min-width:280px !important">
                    ...
                    <div>Data de nascimento:
                        <span class="font-weight-bold">{{ date('d-M-y', strtotime($client->dataNasc)) }}</span></div>
                    <br>
                ...
                <div class="col p-2 pr-3 pb-3" style="min-width:300px !important">
                    ...
                    <div class="nav mt-3">Ver observações:
                        ...
                        <a class="font-weight-bold active ml-2 " id="obsPessoais-tab" data-toggle="tab"
                            href="#obsPessoais" role="tab" aria-controls="obsPessoais" aria-selected="true">Pessoais</a>
                        <span class="mx-2">|</span>
                        <a class="font-weight-bold" id="obsAgentes-tab" data-toggle="tab" href="#obsAgentes" role="tab"
                            aria-controls="obsAgentes" aria-selected="true">Do Agente</a>
                    </div>
                ...
                <div class="row mt-2 pl-2 ">
                    ...
                    <div class="col mr-3 ">
                        ...
                        <div class="border rounded bg-light p-3">
                            ...
                            <br>
                            <div>Data de validade: <span
                                    class="font-weight-bold">{{ date('M-Y', strtotime($client->validade_docOficial)) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="border rounded bg-light p-3">
                            ...
                            {{-- numPassaporte --}}
                            <div>Número do passaporte: <span
                                    class="font-weight-bold my-3">{{$passaporteData->numPassaporte}}</span></div>
                            <br>

                            {{-- dataValidPP --}}
                            <div>Data de validade do passaporte: <span
                                    class="font-weight-bold my-3">{{ date('M-Y', strtotime($passaporteData->dataValidPP)) }}</span>
                            </div><br>

                            {{-- passaportPaisEmi --}}
                            <div>Pais emissor do passaporte: <span
                                    class="font-weight-bold my-3">{{$passaporteData->passaportPaisEmi}}</span></div><br>

                            {{-- localEmissaoPP --}}
                            <div>Local de emissão do passaporte: <span
                                    class="font-weight-bold my-3">{{$passaporteData->localEmissaoPP}}</span></div>
                            @else
