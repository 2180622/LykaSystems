    ...
    <ul class="menu-list">
        ...
        <li class="menu-option">
            <a href="{{route('dashboard')}}">
                <div class="menu-icon">
                    <ion-icon name="cloud-outline" style="font-size: 16pt; position: relative; top: 3px; right: 3px; --ionicon-stroke-width: 40px;">
                    </ion-icon>
                </div>
        ...
        <div class="collapse" id="collapseDiv">
            ...
            <li class="menu-option">
                <a href="{{route('payments.index')}}">
                    <div class="menu-icon">
                        <ion-icon name="wallet-outline" style="font-size:16pt; --ionicon-stroke-width: 50px; position: relative; top: 3px; right: 3px;">
                        </ion-icon>
                    </div>
