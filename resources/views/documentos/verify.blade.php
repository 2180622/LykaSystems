    ...
    <div class="cards-navigation">
        ...
        <div class="formulario-edicao shadow-sm">
            ...
            <div class="row documento">
                ...
                <div class="col-md-8">
                    <a class="" onclick="window.open('../../storage/{{$documento->imagem}}', '', 'width=620,height=450,toolbar=no,location=no,menubar=no,copyhistory=no,status=no,directories=no,scrollbars=yes,resizable=yes'); return false;" href="../../storage/{{$documento->imagem}}" id="yui_3_17_2_1_1589215110643_49">
