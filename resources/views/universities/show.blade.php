    ...
    <div class="cards-navigation">
        ...
        <div class="row">
            <div class="col">
                ...
                <div><span class="text-secondary">Observação dos Contactos:</span> {{$university->obsContactos}}</div>
                <br>

                <div><span class="text-secondary">Observação dos Cursos:</span> {{$university->obsCursos}}</div><br>

                <div><span class="text-secondary">Observação dos Candidaturas:</span> {{$university->obsCandidaturas}}
                </div><br>
            </div>
        </div>
    </div>
