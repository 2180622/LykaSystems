...
<div class="tab-content p-2 " id="myTabContent">
    ...
    <div class="tab-pane fade active show text-muted" id="infos" role="tabpanel" aria-labelledby="infos-tab">
    ...
    <div class="tab-pane fade show text-muted" id="observacoes" role="tabpanel" aria-labelledby="observacoes-tab">
        <div class="row" style="color:#6A74C9">
            {{-- INPUT obsContactos --}}
