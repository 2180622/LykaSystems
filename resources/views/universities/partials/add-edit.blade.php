<div class="row">
    ...
    <div class="form-group cards-navigation col-lg-12 col-md-6">
        ...
        <input required type="text" class="form-control" name="nome" id="inputNome" maxlength="150" placeholder="Insira o nome da Universidade" value="{{old('nome',$university->nome)}}"/>
    ...
    <div class="form-group cards-navigation col-lg-12 col-md-6">
        ...
        <input required type="text" class="form-control" name="morada" id="inputMorada" maxlength="150" placeholder="Insira a morada da universidade" value="{{old('morada',$university->morada)}}"/>
    ...
    <div class="form-group cards-navigation col-lg-6 col-md-6">
        ...
        <input required type="email" class="form-control" name="email" id="inputEmail" maxlength="150" value="{{old('email',$university->email)}}"/>
    ...
    <div class="form-group cards-navigation col-lg-6 col-md-6">
        ...
        <input required type="text" class="form-control" name="telefone" id="inputTelefone" maxlength="150" value="{{old('telefone',$university->telefone)}}"/>
    ...
    <div class="form-group cards-navigation col-lg-6 col-md-6">
        ...
        <input required type="text" class="form-control" name="NIF" id="inputNIF" maxlength="150" value="{{old('NIF',$university->NIF)}}"/>
    ...
    <div class="form-group cards-navigation col-lg-6 col-md-6">
        ...
        <input required type="text" class="form-control" name="IBAN" id="inputIBAN" maxlength="150" value="{{old('IBAN',$university->IBAN)}}"/>
