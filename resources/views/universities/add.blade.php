...
@section('content')
    <div class="container mt-2">
        ...
        <div class="cards-navigation">
            ...
            <br>
            <form method="POST" action="{{route('universities.store')}}" class="form-group pt-3" id="form_universities" enctype="multipart/form-data">
                @csrf
                @include('universities.partials.add-edit')
                <div class="form-group text-right">
                    <br><br>
                    <button type="button" class="top-button" name="ok" id="buttonSubmit"><i class="fas fa-plus text-white-50 mr-2"></i>Adicionar Universidade</button>
