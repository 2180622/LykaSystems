                              ...
                              <div class="row">
                                  <div class="col">
                                      ...
                                      <select type="text" class="form-control" name="tipo" id="tipodocstock"
                                        onchange="myFunction('tipoacademico', this)" required>
...
@section('scripts')
  ...
  function myFunction(divId, element) {
    ...
    //   document.getElementById(tipopessoal).style.display = 'block';
    //   document.getElementById(tipoacademico).style.display = 'none';
    // }else {
    //   document.getElementById(tipopessoal).style.display = 'none';
    //   document.getElementById(tipoacademico).style.display = 'block';
    // }

    document.getElementById(divId).style.display = element.value == 'Academico' ? 'block' : 'none';
    document.getElementById(divId).style.display = element.value == 'Pessoal' ? 'block' : 'none';
  }
  </script>
