                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="startDate" name="dataInicio" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="endDate" name="dataFim" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
