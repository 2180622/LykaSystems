...
<div class="form" id="form-admin" onchange="visibility()" style="display: none">
  ...
  <div class="form-group">
     ...
     placeholder="username@gmail.com" value="<?php echo e(old('email',$user->email)); ?>" />
  </div>
  <div class="form-group">
...
<?php /**PATH /home/joseareia/Desktop/LykaSystems/resources/views/users/partials/add-edit.blade.php ENDPATH**/ ?>