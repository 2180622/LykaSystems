    ...
    <ul class="menu-list">
        ...
        <li class="menu_option">
            <a href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="<?php echo e(Route::is('dashboard') ? 'active' : ''); ?>">Dashboard</span>
            </a>
        </li>
        ...
        <li class="menu_option">
            <a href="<?php echo e(route('users.index')); ?>">
                ...
                <span class="<?php echo e(Route::is('users.*') ? 'active' : ''); ?>">Utilizadores</span>
            </a>
        </li>
...
<?php /**PATH /home/joseareia/Desktop/LykaSystems/resources/views/layout/partials/main_menu.blade.php ENDPATH**/ ?>